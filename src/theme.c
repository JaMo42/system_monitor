...
static short ParseColor(const char *rep) {
    ...
    static const char *const NAMES[] = {
        ...
        "Khaki1", "Wheat1", "Cornsilk1", "Grey100", "Grey3", "Grey7", "Grey11",
        "Grey15", "Grey19", "Grey23", "Grey27", "Grey30", "Grey35", "Grey39",
        "Grey42", "Grey46", "Grey50", "Grey54", "Grey58", "Grey62", "Grey66",
        "Grey70", "Grey74", "Grey78", "Grey82", "Grey85", "Grey89", "Grey93",
    };
    if ((*rep >= '0' && *rep <= '9') || *rep == '-') {
        return atoi(rep);
    }
...
static ColorDef ParseColorDef(const char *rep) {
    ColorDef def = {0, 0};
