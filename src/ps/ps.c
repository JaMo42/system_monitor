...
static void
update_process(int dir_fd, Proc_Data *process) {
    Proc_Stat stat;
...
static Proc_Data *
add_or_update(pid_t pid, bool force) {
...
static void
remove_child(Proc_Data *parent, pid_t child) {
